...
class AVLTree:
	...
	def insertFromFile(self,filename):
		try:
			...
			print("inserted values from "+filename)
		except:
...
while(1):
	...
	if(choice == '1'):
		...
		createData(file,key_num)

		a.insertFromFile(file)
		...
		find_key = input("Enter the key to be searched")

		start_time = time.process_time()

		res = a.search(find_key)
		...
		delt = input("Enter the key to be deleted")
